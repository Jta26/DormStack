...
export default class PhoneAuthListener {
   ...
   * @param timeout
   */
  constructor(auth, phoneNumber, timeout) {
    this._auth = auth;
    this._reject = null;
    this._resolve = null;
    this._promise = null;
    ...
    if (isAndroid) {
      this._auth._native.verifyPhoneNumber(phoneNumber, this._phoneAuthRequestKey, this._timeout);
    }

    if (isIOS) {
      this._auth._native.verifyPhoneNumber(phoneNumber, this._phoneAuthRequestKey);
    }
  }
